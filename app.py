...
with app.app_context():
    try:
        db.create_all() 
        models.seed_system()
        print("✅ نظام محجوب أونلاين: القاعدة جاهزة.")
...
def vendors_accreditation():
    ...
    # تأكدنا أن اسم الملف في مجلدك هو admin_accounts.html
...
def vendor_dashboard():
    ...
    return render_template('vendor_dashboard.html', username=username, vendor=vendor_data,
                           wallet_no=wallet.wallet_number if wallet else "N/A", balance=wallet.balance if wallet else 0.0)
